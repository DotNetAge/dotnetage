...
{
    public class MySQLWebPageConfiguration : EntityTypeConfiguration<WebPage>
    {
        public MySQLWebPageConfiguration() 
        {
            ...
            Property(p => p.CssText).HasColumnType("LONGTEXT");
            Property(p => p.UnsaveContent).HasColumnType("LONGTEXT");
            Property(p => p.AdditionalData).HasColumnType("LONGTEXT");
            Property(p => p.Keywords).HasMaxLength(256);
            Property(p => p.Description).HasMaxLength(256);
            Property(p => p.ViewData).HasColumnType("LONGTEXT");
        }
    }
}
