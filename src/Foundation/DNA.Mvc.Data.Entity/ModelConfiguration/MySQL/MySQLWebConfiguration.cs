...
{
    public class MySQLWebConfiguration : EntityTypeConfiguration<Web>
    {
        public MySQLWebConfiguration()
        {
            ...
            Property(w => w.LocData).HasColumnType("LONGTEXT");
            Property(w => w.Copyright).HasColumnType("LONGTEXT");
            Property(w => w.CssText).HasColumnType("LONGTEXT");
            Property(w => w.Data).HasColumnType("LONGTEXT");
            Property(w => w.Description).HasColumnType("LONGTEXT");
