...
{
    public class SqlUserProfileConfiguration : EntityTypeConfiguration<UserProfile>
    {
        public SqlUserProfileConfiguration()
        {
            ...
            Property(p => p.Signature).HasColumnType("ntext");
            Property(p => p.Data).HasColumnType("ntext");
        }
    }
}
