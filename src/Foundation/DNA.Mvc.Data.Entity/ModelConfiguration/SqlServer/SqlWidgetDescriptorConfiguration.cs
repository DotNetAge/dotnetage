...
{
    public class SqlWidgetDescriptorConfiguration : EntityTypeConfiguration<WidgetDescriptor>
    {
        public SqlWidgetDescriptorConfiguration()
        {
            ...
            Property(d => d.ContentText).HasColumnType("ntext");
            Property(d => d.Defaults).HasColumnType("ntext");
            Property(d => d.ConfigXml).HasColumnType("ntext");
            Property(d => d.Description).HasColumnType("ntext");
